# Generated by Django 5.1.1 on 2024-11-14 14:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='buyer_groups', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='buyer_permissions', to='auth.permission')),
                ('sellers', models.ManyToManyField(related_name='buyers', to='realestate.seller')),
                ('surveyors', models.ManyToManyField(related_name='buyers', to='realestate.surveyor')),
            ],
            options={
                'verbose_name': 'user',
